...
public class GetPartner {
    /**
     * This function listens at endpoint "/api/GetPartner". Two ways to invoke it
     * using "curl" command in bash: 1. curl -d "HTTP Body" {your
     * host}/api/GetPartner 2. curl {your host}/api/GetPartner?name=HTTP%20Query
     */
    ...
    public HttpResponseMessage run(@HttpTrigger(name = "req", methods = {
        ...
        try {
            ...
            Map<String, Object> data = new PartnerDao().getPartner(Long.parseLong(syskey));
