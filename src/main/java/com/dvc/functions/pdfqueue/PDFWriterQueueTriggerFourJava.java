 ...
 */
public class PDFWriterQueueTriggerFourJava {
    /**
     ...
     */
    @FunctionName("PDFWriterQueueTriggerFourJava")
    public void run(
            @QueueTrigger(name = "messageFour", queueName = "pdf-queue-four", connection = "AzureStorageConnectionString") String message,
