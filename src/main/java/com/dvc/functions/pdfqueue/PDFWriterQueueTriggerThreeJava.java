 ...
 */
public class PDFWriterQueueTriggerThreeJava {
    /**
     ...
     */
    @FunctionName("PDFWriterQueueTriggerThreeJava")
    public void run(
            @QueueTrigger(name = "messageThree", queueName = "pdf-queue-three", connection = "AzureStorageConnectionString") String message,
