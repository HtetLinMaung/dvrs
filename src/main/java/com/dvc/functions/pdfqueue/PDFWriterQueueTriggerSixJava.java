 ...
 */
public class PDFWriterQueueTriggerSixJava {
    /**
     ...
     */
    @FunctionName("PDFWriterQueueTriggerSixJava")
    public void run(
            @QueueTrigger(name = "messageSix", queueName = "pdf-queue-six", connection = "AzureStorageConnectionString") String message,
