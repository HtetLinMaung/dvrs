 ...
 */
public class PDFWriterQueueTriggerTwoJava {
    /**
     ...
     */
    @FunctionName("PDFWriterQueueTriggerTwoJava")
    public void run(
            @QueueTrigger(name = "messageTwo", queueName = "pdf-queue-two", connection = "AzureStorageConnectionString") String message,
