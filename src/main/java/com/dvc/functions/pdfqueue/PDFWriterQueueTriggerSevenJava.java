 ...
 */
public class PDFWriterQueueTriggerSevenJava {
    /**
     ...
     */
    @FunctionName("PDFWriterQueueTriggerSevenJava")
    public void run(
            @QueueTrigger(name = "messageSeven", queueName = "pdf-queue-seven", connection = "AzureStorageConnectionString") String message,
