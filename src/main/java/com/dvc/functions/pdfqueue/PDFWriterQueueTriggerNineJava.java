 ...
 */
public class PDFWriterQueueTriggerNineJava {
    /**
     ...
     */
    @FunctionName("PDFWriterQueueTriggerNineJava")
    public void run(
            @QueueTrigger(name = "messageNine", queueName = "pdf-queue-nine", connection = "AzureStorageConnectionString") String message,
