 ...
 */
public class PDFWriterQueueTriggerEightJava {
    /**
     ...
     */
    @FunctionName("PDFWriterQueueTriggerEightJava")
    public void run(
            @QueueTrigger(name = "messageEight", queueName = "pdf-queue-eight", connection = "AzureStorageConnectionString") String message,
