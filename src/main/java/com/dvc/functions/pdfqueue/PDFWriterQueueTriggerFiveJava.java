 ...
 */
public class PDFWriterQueueTriggerFiveJava {
    /**
     ...
     */
    @FunctionName("PDFWriterQueueTriggerFiveJava")
    public void run(
            @QueueTrigger(name = "messageFive", queueName = "pdf-queue-five", connection = "AzureStorageConnectionString") String message,
