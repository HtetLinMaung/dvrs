 ...
 */
public class GetQRSummary {
    /**
     * This function listens at endpoint "/api/GetQRSummary". Two ways to invoke it
     * using "curl" command in bash: 1. curl -d "HTTP Body" {your
     * host}/api/GetQRSummary 2. curl {your host}/api/GetQRSummary?name=HTTP%20Query
     */
    @FunctionName("getqrsummary")
