 ...
 */
public class GetCentersByPagination {
    /**
     * This function listens at endpoint "/api/GetCentersByPagination". Two ways to
     * invoke it using "curl" command in bash: 1. curl -d "HTTP Body" {your
     * host}/api/GetCentersByPagination 2. curl {your
     * host}/api/GetCentersByPagination?name=HTTP%20Query
     */
    @FunctionName("getcentersbypagination")
    public HttpResponseMessage run(@HttpTrigger(name = "req", methods = {
        ...
        try {
            ...
            PaginationResponse<Map<String, Object>> resData = new CenterDao().getCenters(dto);
