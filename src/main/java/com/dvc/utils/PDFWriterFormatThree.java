...
public class PDFWriterFormatThree implements PDFWriter {
	...
	public void writePDF(RecipentsData rdata, Document document, Font font, Font hfont, Font fontb, Font idFont,
		...
		try {
			...
			secondbodytable.setTotalWidth(new float[] { 135, 125, 110, 130 });
			...
			// headertable.addCell(new PDFUtil().writePDFCell("COVID-19 Vaccination Record
			// Card", hfont,
			...
			secondbodytable.addCell(new PDFUtil().writePDFCell("NRC No. (ႏိုင္ငံသားစိစစ္ေရးကတ္ျပားအမွတ္)", lblFont, -1,
					-1, 0, -1f, 0, -1f));
			secondbodytable.addCell(
					new PDFUtil().writePDFCell(new PDFUtil().convertString(rdata.getNRIC(), "Myanmar3", "Zawgyi_One"),
							fontb, -1, -1, 0, 0.5f, 0, -1f));
			secondbodytable.addCell(new PDFUtil().writePDFCell("Passport No. (ႏိုင္ငံကူးလက္မွတ္)", lblFont, -1,
